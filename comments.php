...
?>">
    ...
    <div class="comment-meta">
       <cite class="fn"><?php $singleCommentOptions->beforeAuthor();
                ...
                $singleCommentOptions->afterDate(); ?></a> <span class="comment-reply"><?php $comments->reply($singleCommentOptions->replyWord); //输出 回复 链接?></span>
    </div>
    <div class="comment-p">
...
<div id="comments">
			...
			<form method="post" action="<?php $this->commentUrl() ?>" id="comment_form">
				...
				<p>已经登录 <a href="<?php $this->options->logoutUrl(); ?>" title="Logout"><?php _e('[退出]'); ?></a></p>
                <?php else: ?>
				<p>
				...
				<?php endif; ?>
				<p><input type="submit" tabindex="5" value="<?php _e('提交评论'); ?>" class="submit" id="submit"/></p>		
				</div>
				<div class="clear"></div>
			</form>
            </div>
            ...
            <?php $comments->pageNav('PRE','NEX',14,'...'); ?>
